...
//								.extract().response();
//				String place = response.jsonPath().getString("place_id"); // no need to convert the response into JsonPath Object Class.
//				System.out.println("Filtered Place_ID on the body: "+place);
		/**********************************************************************************************/
